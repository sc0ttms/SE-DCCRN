...
class PruneInferencer(BaseInferencer):
    def __init__(self, config, model_path, model, test_iter, device="cpu"):
        ...
        # init path
        self.output_path = os.path.join(self.base_path, "enhanced", "prune")
        self.logs_path = os.path.join(self.base_path, "logs", "inference", "prune")
        self.metrics_path = os.path.join(self.base_path, "metrics", "prune")
        # mkdir path
...
if __name__ == "__main__":
    ...
    model_path = os.path.join(base_path, "checkpoints", "prune", "prune_model.pth")
    ...
    # inferencer
    inference = PruneInferencer(config, model_path, model, test_iter, device)
