...
class KnowledgeDistillationInferencer(BaseInferencer):
    def __init__(self, config, model_path, model, test_iter, device="cpu"):
        ...
        # init path
        self.output_path = os.path.join(self.base_path, "enhanced", "knowledge_distillation")
        self.logs_path = os.path.join(self.base_path, "logs", "inference", "knowledge_distillation")
        self.metrics_path = os.path.join(self.base_path, "metrics", "knowledge_distillation")
        # mkdir path
...
if __name__ == "__main__":
    ...
    # inferencer
    inference = KnowledgeDistillationInferencer(config, model_path, model, test_iter, device)
